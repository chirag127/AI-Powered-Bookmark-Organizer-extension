...
(async () => {
    try {
        categories = [
            {
                name: "Technology",
                description: "Tech news, gadgets, software, and digital trends",
            },
            {
                name: "News",
                description: "Current events, world news, and headlines",
            },
            {
                name: "Education",
                description:
            ...
            {
                name: "Entertainment",
                description: "Movies, TV shows, music, and other entertainment",
            },
            {
                name: "Finance",
                description: "Personal finance, investing, and financial news",
            },
            {
                name: "Health",
                description: "Health tips, medical information, and wellness",
            },
            {
                name: "Travel",
            ...
            {
                name: "Shopping",
                description: "Online stores, products, and shopping guides",
            },
            {
                name: "Social Media",
                description: "Social networking sites and content",
            },
            {
                name: "Uncategorized",
                description: "Bookmarks that don't fit other categories",
            },
        ];
    } catch (error) {
...
module.exports = {
    ...
    // Export the categories arrays for direct access by other controllers
    categories,
    customCategories,
};
